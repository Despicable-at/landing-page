...
const InvestPage = ({ user }) => {
  ...
  const incrementAmount = () => setAmount(prev => Math.min(parseInt(prev) + 100, 10000));
  const decrementAmount = () => setAmount(prev => Math.max(parseInt(prev) - 100, 500));
...
10. Acknowledgment
- By proceeding, you agree to these terms and accept all associated risks.
    `, 10, 20);
  ...
  return (
    <div className="auth-container">
      ...
      <div className="terms-box">
        ...
        <p><strong>2. Share Allocation:</strong> Equity ownership, dividends, and non-transferability conditions.</p>
        ...
        <p><strong>5. Risk:</strong> Investment risks including potential loss of capital.</p>
